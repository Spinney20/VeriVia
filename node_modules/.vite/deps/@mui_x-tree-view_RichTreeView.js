import {
  ButtonBase_default
} from "./chunk-FNC5TFZX.js";
import {
  getTransitionProps,
  useFormControl,
  useSlot
} from "./chunk-MUD3VV74.js";
import {
  Transition_default,
  ...
  useForkRef_default
} from "./chunk-GUM6CMXM.js";
import "./chunk-6ZJUQ7RT.js";
import {
  useThemeProps
} from "./chunk-MSIGRYAZ.js";
import {
  useTheme
} from "./chunk-BR64V66B.js";
import {
  useDefaultProps
} from "./chunk-YQERXXJE.js";
import {
  _extends,
  alpha,
  clsx_default,
...
var TreeItemContent = React24.forwardRef(function TreeItemContent2(props, ref) {
  const {
    classes,
    className,
    displayIcon,
  ...
  const checkboxRef = React24.useRef(null);
...
var TreeItem = React26.forwardRef(function TreeItem2(inProps, inRef) {
  var _a, _b, _c, _d;
  const {
    icons: contextIcons,
    runItemPlugins,
  ...
  const depthContext = React26.useContext(TreeViewItemDepthContext);
  ...
  const contentRefObject = React26.useRef(null);
...
function WrappedTreeItem({
  ...
  const children = React27.useMemo(() => itemsToRender ? (0, import_jsx_runtime13.jsx)(RichTreeViewItems, {
    itemsToRender,
    slots,
    slotProps
...
var RichTreeView = React28.forwardRef(function RichTreeView2(inProps, ref) {
