import {
  Collapse_default
} from "./chunk-3KDHQLYP.js";
import {
  Checkbox_default
} from "./chunk-PNGS6YD6.js";
import "./chunk-ZJCRSJZ3.js";
import {
  useThemeProps
} from "./chunk-LFFYOXEY.js";
import "./chunk-QSNV7DNS.js";
import {
  _objectWithoutPropertiesLoose
} from "./chunk-AVSHSFBY.js";
import "./chunk-MN7GNKN2.js";
import "./chunk-2DOWZLXY.js";
import "./chunk-ZCSSBJ3Q.js";
import "./chunk-LAV6FB6A.js";
import {
  createSvgIcon
} from "./chunk-ENUISOOB.js";
import "./chunk-XXQREE4T.js";
import "./chunk-EGUAXMLH.js";
import "./chunk-3I62RVVX.js";
import "./chunk-EVQHIOIV.js";
import "./chunk-VQPMOM6S.js";
import {
  _extends,
  alpha,
  clsx_default,
...
function TreeItem2DragAndDropOverlay(props) {
  ...
  return (0, import_jsx_runtime3.jsx)(TreeItem2DragAndDropOverlayRoot, _extends({}, props));
}
...
var TreeItemContent = React18.forwardRef(function TreeItemContent2(props, ref) {
  const {
    classes,
    className,
    displayIcon,
  ...
  return (
    ...
    (0, import_jsx_runtime4.jsxs)("div", _extends({}, other, {
      ...
      children: [(0, import_jsx_runtime4.jsx)("div", {
        ...
        children: icon
      }), checkboxSelection && (0, import_jsx_runtime4.jsx)(Checkbox_default, {
        ...
        ref: checkboxRef,
        tabIndex: -1
      }), editing ? (0, import_jsx_runtime4.jsx)(TreeItem2LabelInput, _extends({}, labelInputProps, {
        className: classes.labelInput
      })) : (0, import_jsx_runtime4.jsx)("div", _extends({
        className: classes.label
      }, editable && {
        onDoubleClick: handleLabelDoubleClick
      }, {
        children: label
      })), dragAndDropOverlayProps && (0, import_jsx_runtime4.jsx)(TreeItem2DragAndDropOverlay, _extends({}, dragAndDropOverlayProps))]
    }))
  );
});
...
var TreeViewExpandIcon = createSvgIcon((0, import_jsx_runtime5.jsx)("path", {
  d: "M10 6 8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"
}), "TreeViewExpandIcon");
var TreeViewCollapseIcon = createSvgIcon((0, import_jsx_runtime5.jsx)("path", {
...
var TreeItem = React20.forwardRef(function TreeItem2(inProps, inRef) {
  var _a, _b, _c, _d;
  const {
    icons: contextIcons,
    runItemPlugins,
  ...
  const depthContext = React20.useContext(TreeViewItemDepthContext);
  ...
  const contentRefObject = React20.useRef(null);
  ...
  const expansionIcon = expandable && !!ExpansionIcon ? (0, import_jsx_runtime6.jsx)(ExpansionIcon, _extends({}, expansionIconProps)) : null;
  ...
  const displayIcon = DisplayIcon ? (0, import_jsx_runtime6.jsx)(DisplayIcon, _extends({}, displayIconProps)) : null;
  ...
  const icon = Icon ? (0, import_jsx_runtime6.jsx)(Icon, _extends({}, iconProps)) : null;
  let ariaSelected;
  if (selected) {
    ariaSelected = true;
  ...
  return (0, import_jsx_runtime6.jsx)(TreeItem2Provider, {
    itemId,
    children: (0, import_jsx_runtime6.jsxs)(TreeItemRoot, _extends({
      ...
      children: [(0, import_jsx_runtime6.jsx)(StyledTreeItemContent, _extends({
        as: ContentComponent,
        classes: {
      ...
      })), children && (0, import_jsx_runtime6.jsx)(TreeItemGroup, _extends({
        as: GroupTransition
...
function WrappedTreeItem({
  ...
  const children = React21.useMemo(() => itemsToRender ? (0, import_jsx_runtime7.jsx)(RichTreeViewItems, {
    itemsToRender,
    slots,
    slotProps
  }) : null, [itemsToRender, slots, slotProps]);
  return (0, import_jsx_runtime7.jsx)(Item, _extends({}, itemProps, {
    children
  }));
}
function RichTreeViewItems(props) {
  ...
  return (0, import_jsx_runtime7.jsx)(React21.Fragment, {
    children: itemsToRender.map((item) => (0, import_jsx_runtime7.jsx)(WrappedTreeItem, {
      slots,
      slotProps,
      label: item.label,
      id: item.id,
...
var RichTreeView = React22.forwardRef(function RichTreeView2(inProps, ref) {
  ...
  return (0, import_jsx_runtime8.jsx)(TreeViewProvider, {
    value: contextValue,
    children: (0, import_jsx_runtime8.jsx)(Root, _extends({}, rootProps, {
      children: (0, import_jsx_runtime8.jsx)(RichTreeViewItems, {
        slots,
        slotProps,
...
true ? RichTreeView.propTypes = {
  ...
  apiRef: import_prop_types5.default.shape({
    current: import_prop_types5.default.shape({
      focusItem: import_prop_types5.default.func.isRequired,
      getItem: import_prop_types5.default.func.isRequired,
      getItemDOMElement: import_prop_types5.default.func.isRequired,
      getItemOrderedChildrenIds: import_prop_types5.default.func.isRequired,
      getItemTree: import_prop_types5.default.func.isRequired,
      selectItem: import_prop_types5.default.func.isRequired,
      setItemExpansion: import_prop_types5.default.func.isRequired,
      updateItemLabel: import_prop_types5.default.func.isRequired
    })
  }),
  /**
   ...
   * @default false
   */
  checkboxSelection: import_prop_types5.default.bool,
  /**
   * Override or extend the styles applied to the component.
   */
   ...
   * @default []
   */
  defaultExpandedItems: import_prop_types5.default.arrayOf(import_prop_types5.default.string),
  /**
   * Selected item ids. (Uncontrolled)
   * When `multiSelect` is true this takes an array of strings; when false (default) a string.
   * @default []
   */
  defaultSelectedItems: import_prop_types5.default.any,
  /**
   ...
   * @default false
   */
  disableSelection: import_prop_types5.default.bool,
  /**
   * Expanded item ids.
   * Used when the item's expansion is controlled.
   */
  expandedItems: import_prop_types5.default.arrayOf(import_prop_types5.default.string),
  /**
   * The slot that triggers the item's expansion when clicked.
   * @default 'content'
   */
  expansionTrigger: import_prop_types5.default.oneOf(["content", "iconContainer"]),
  /**
  ...
  experimentalFeatures: import_prop_types5.default.shape({
    indentationAtItemLevel: import_prop_types5.default.bool,
    labelEditing: import_prop_types5.default.bool
  }),
  /**
   ...
   */
  getItemId: import_prop_types5.default.func,
  /**
   ...
   */
  getItemLabel: import_prop_types5.default.func,
  /**
   ...
   */
  isItemDisabled: import_prop_types5.default.func,
  /**
   ...
   */
  isItemEditable: import_prop_types5.default.oneOfType([import_prop_types5.default.func, import_prop_types5.default.bool]),
  /**
   * Horizontal indentation between an item and its children.
   * Examples: 24, "24px", "2rem", "2em".
   * @default 12px
   */
  itemChildrenIndentation: import_prop_types5.default.oneOfType([import_prop_types5.default.number, import_prop_types5.default.string]),
  items: import_prop_types5.default.array.isRequired,
  /**
   * If `true`, `ctrl` and `shift` will trigger multiselect.
   * @default false
   */
  multiSelect: import_prop_types5.default.bool,
  /**
   * Callback fired when Tree Items are expanded/collapsed.
   * @param {React.SyntheticEvent} event The DOM event that triggered the change.
   * @param {array} itemIds The ids of the expanded items.
   */
  onExpandedItemsChange: import_prop_types5.default.func,
  /**
   ...
   */
  onItemExpansionToggle: import_prop_types5.default.func,
  /**
   * Callback fired when a given Tree Item is focused.
   * @param {React.SyntheticEvent | null} event The DOM event that triggered the change. **Warning**: This is a generic event not a focus event.
   * @param {string} itemId The id of the focused item.
   */
  onItemFocus: import_prop_types5.default.func,
  /**
   * Callback fired when the label of an item changes.
   * @param {TreeViewItemId} itemId The id of the item that was edited.
   * @param {string} newLabel The new label of the items.
   */
  onItemLabelChange: import_prop_types5.default.func,
  /**
   ...
   */
  onItemSelectionToggle: import_prop_types5.default.func,
  /**
   ...
   */
  onSelectedItemsChange: import_prop_types5.default.func,
  /**
   * Selected item ids. (Controlled)
   * When `multiSelect` is true this takes an array of strings; when false (default) a string.
   */
  selectedItems: import_prop_types5.default.any,
  /**
   * The props used for each component slot.
   * @default {}
   */
